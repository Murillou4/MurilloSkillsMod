...
public class MeltingTouchHud {
    ...
    public static void render(DrawContext context, RenderTickCounter tickCounter) {
        ...
        context.fill(x, y + panelH - 1, x + panelW, y + panelH, 0xFFFFAA00);
        context.fill(x, y, x + 1, y + panelH, 0xFFFFAA00);
        context.fill(x + panelW - 1, y, x + panelW, y + panelH, 0xFFFFAA00);
        context.fill(x + 1, y + 1, x + 3, y + panelH - 1, 0xFFFFDD55);
