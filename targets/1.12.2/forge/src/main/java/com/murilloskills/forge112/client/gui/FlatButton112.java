...
public final class FlatButton112 extends GuiButton {
    public FlatButton112(int buttonId, int x, int y, int widthIn, int heightIn, String buttonText) {
    ...
    public void drawButton(Minecraft mc, int mouseX, int mouseY, float partialTicks) {
        ...
        if (displayString != null && displayString.length() > 0) {
            ...
            int textColor = enabled ? (hovered ? Palette.TEXT_GOLD : Palette.TEXT_LIGHT) : Palette.TEXT_MUTED;
            int tx = x + (width - mc.fontRenderer.getStringWidth(text)) / 2;
            int ty = y + (height - 8) / 2;
            mc.fontRenderer.drawStringWithShadow(text, (float) tx, (float) ty, textColor);
        }
    }
}
