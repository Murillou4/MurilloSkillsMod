...
public final class SelfTestFixture {
    public final BlockPos orePos;
    public final BlockPos chestPos;
    public final BlockPos cropPos;
    public final BlockPos brushOrigin;
    public final ItemStack damagedTool;
    public final int initialToolDamage;

    public SelfTestFixture(BlockPos orePos, BlockPos chestPos, BlockPos cropPos, BlockPos brushOrigin,
            ItemStack damagedTool, int initialToolDamage) {
        this.orePos = orePos;
        this.chestPos = chestPos;
        this.cropPos = cropPos;
        this.brushOrigin = brushOrigin;
        this.damagedTool = damagedTool;
